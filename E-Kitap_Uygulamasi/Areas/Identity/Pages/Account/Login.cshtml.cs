...
namespace E_Kitap_Uygulamasi.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
    public class LoginModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                var result = await _signInManager.PasswordSignInAsync(Input.Mahlas, Input.Password, Input.RememberMe, lockoutOnFailure: false);
                if (result.Succeeded)
                {
